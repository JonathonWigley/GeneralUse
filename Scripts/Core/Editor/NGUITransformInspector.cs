...
// Copyright Š 2011-2013 Tasharen Entertainment
...
//		EditorGUIUtility.LookLikeControls(15f);
		...
		EditorGUILayout.BeginHorizontal();
		{
			...
			{
				NGUITransformInspector.RegisterUndo("Reset Position", serializedObject.targetObjects);
		...
		EditorGUILayout.BeginHorizontal();
		{
			...
			{
				NGUITransformInspector.RegisterUndo("Reset Rotation", serializedObject.targetObjects);
		...
		EditorGUILayout.BeginHorizontal();
		{
			...
			{
				NGUITransformInspector.RegisterUndo("Reset Scale", serializedObject.targetObjects);
		...
		{
			NGUITransformInspector.RegisterUndo("Transform Change", serializedObject.targetObjects);
